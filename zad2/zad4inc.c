...
// Define a function to print a string on the LCD
...
// Define a function to set the cursor position on the LCD
...
// Define a function to initialize the LCD
void LCD_init(){
    __delay_ms(20);
...
// Define a function to read the analog value from the ADC
...
// Define a function to display the time on the LCD
...
// Define a function to display the power on the LCD
...
int main(void) {
    ...
    while(1) {
        // Read and normalize the power value
        power = display() / 10; 
        if (power > 100) power = 100;  // Ensure the power value does not exceed 100
